                    ...
                    if(cnx):
                        ...
                        try:
                            ...
                            if(int(cursor.rowcount)>=1):
                                ...
                                ibt=Button(frm1,width=10,text="Scan",bg="gray",fg="#990066",command=invoke)
                                ...
                                ibt=Button(frm1,width=10,text="Profile",bg="gray",fg="#990066",command=invoke1)
                                ibt.grid(row=4,column=1,sticky= S)
