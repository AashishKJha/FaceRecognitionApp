...
class attendance:
    try:
        ...
        def new(self,mwindow,e_mail,pass_word):
            ...
            frm4=Frame(frm2,height=100,width=660,bg="#FF33FF")
            frm4.grid(row=1,column=1,sticky= W+N+S+E)

            id_lbl=Label(frm4,text="College ID",width=25,fg="blue",bg="#FF33FF")
            id_lbl.grid(row=1,column=1,sticky=W,padx=2)

            n_lbl=Label(frm4,text="Name",width=25,fg="blue",bg="#FF33FF")
            n_lbl.grid(row=1,column=2,sticky=W,padx=2)

            mark_lbl=Label(frm4,text="Mark Attendance",width=23,fg="blue",bg="#FF33FF")
            mark_lbl.grid(row=1,column=3,sticky=W,padx=2)

            details=Label(frm4,text="Details",width=23,fg="blue",bg="#FF33FF")
